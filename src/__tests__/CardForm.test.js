  ...
  describe('Рендер', () => {
    ...
    describe('Должен присутствовать элемент с классом ', () => {
      ...
      it('onChange input[name="cardNumber"] должен вызывать handleChangeForm', () => {
        ...
        const wrapper = shallow(<CardForm onChangeTimeOver={jest.fn()} onChangeForm={onChangeFormMock} />);
    ...
    describe('Методы класса', () => {
      const onChangeFormMock = jest.fn();
      const wrapper = mount(<CardForm onChangeTimeOver={jest.fn()} onChangeForm={onChangeFormMock} />);
